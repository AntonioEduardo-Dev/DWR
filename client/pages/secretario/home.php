...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="../../dist/img/WRLogo.jpg" alt="DWR Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Tráfego</span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <span class="description-text">TOTAL EM AGUARDO</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <span class="description-text">TOTAL AUMENTO</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block">
                      ...
                      <h5 class="description-header">1043</h5>
                      <span class="description-text">METAS ATINGIDAS</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>

...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="home.html" class="brand-link">
        <img src="../../dist/img/WRLogo.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" id="editar_nome_insumo" placeholder="Ex: AstraZeneca" class="form-control datetimepicker-input"
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                          <input type="text" id="editar_descricao_insumo" placeholder="Ex: Vacina covid-19" class="form-control datetimepicker-input"
                      ...
                      <div class="row mt-1">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            <select id="editar_categoria_insumo" class="form-control select2" style="width: 100%;">
                        ...
                        <!-- <div class="col-md-6">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              <input id="editar_imagem_insumo" type="file" class="custom-file-input">
                      ...
                      <div class="row">
                        <div class="col-md-12 text-center">
                          <div class="custom-control custom-checkbox">
                            <input id="editar_disponibilidade_insumo" class="custom-control-input" type="checkbox" value="option1">
                            <label for="editar_disponibilidade_insumo" class="custom-control-label">Disponível</label>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12 text-center mt-4 mb-3">
                          <button type="submit" class="btn btn-primary btn-block" onclick="editar()">Editar</button>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <script src="../../assets/js/secretario/insumos/editar.js"></script>
</body>

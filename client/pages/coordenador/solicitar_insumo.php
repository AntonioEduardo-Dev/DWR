...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="solicitar_insumo.html" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Solicitar</p>
                  </a>
                </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Solicitar Insumo</h5>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <select id="insumo" class="form-control select2" style="width: 100%;">
                      ...
                      <div class="row mt-1">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                              <input type="text" id="observacao" placeholder="Ex: 3"
                                class="form-control datetimepicker-input" data-target="#reservationdatetime" />
                              <div class="input-group-append" data-target="#reservationdatetime"
                                data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fas fa-tablets"></i></div>
                      ...
                      <!-- <div class="form-group">
                        <label>*Senha:</label>
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                          <input type="password" id="senha" placeholder="Ex: 3"
                            class="form-control datetimepicker-input" data-target="#reservationdatetime" />
                          <div class="input-group-append" data-target="#reservationdatetime"
                            data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fas fa-tablets"></i></div>
                      ...
                      <div class="row">
                        <div class="col-md-12 text-center mt-4 mb-3">
                          <button type="submit" id="solicitar_insumo"
                            class="btn btn-primary btn-block">Solicitar</button>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <script src="../../assets/js/coordenador/pedidos/solicitar.js"></script>
  <!-- END SCRIPS CRUD -->
</body>
